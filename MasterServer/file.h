...
typedef struct file_s {
	...
	int type; /* file type */
	gfs_list_t *chunks;/* list of chunks here */
} file_t;
...
extern file_t *file_create(const char *path, mode_t mode, int type, gfs_node_t* root);   /* create a file and add it to the filetree */
